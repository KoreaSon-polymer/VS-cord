...
- University expansion includes SNU, POSTECH, Korea, Yonsei, SKKU, Hanyang, Pusan, PKNU and KNU, in addition to the four science institutes. Ten pages of the Korean Council for University Education faculty board cover additional universities nationwide. This supplements 17 institute boards and ALIO/JOB-ALIO. A configured source is not a guarantee of successful coverage.
...
## Nationwide chemistry scope update (2026-09-06)

There is no university, institute, prestige or regional allowlist in job filtering. The intent is all Korean chemistry-related faculty appointments and permanent institute research positions. This is the desired scope, not a claim that every Korean notice is collected. Direct sources currently cover 13 universities and 17 research institutes; KCUE (10 pages), NST institute notices (6 pages), ALIO and JOB-ALIO supplement them. The added direct boards are KRIBB, KIGAM and KFRI. NST original-notice forwarding and KFRI clickable rows are supported. Source limits, inaccessible pages and unparsed attachments can still cause omissions.

Broad chemistry areas include organic/inorganic/physical/analytical/computational chemistry, biochemistry, chemical education, chemical engineering, polymers, materials, environmental chemistry/engineering and chemistry-related interdisciplinary areas. Devices, photovoltaics, electronics, catalysts, batteries and biomaterials need explicit matching field evidence. Chemistry-specific keywords are not required when an applicable materials or device specialty is named. Unrelated jobs remain excluded.
